...
public:
    ...
    // Get関数
    D3DXVECTOR3 &GetposV()       { return m_posV; }              // カメラ座標
    D3DXVECTOR3 &GetposR()       { return m_posR; }              // カメラ角度
    D3DXVECTOR3 &GetposU()       { return m_posU; }              // 上方向ベクトル
    D3DXVECTOR3 &GetposVDest()   { return m_posVDest; }          // 目的の座標
    D3DXVECTOR3 &GetposRDest()   { return m_posRDest; }          // 目的の角度
    D3DXVECTOR3 &GetRot()        { return m_rot; }               // 向き
    D3DXMATRIX GetMtxView()const { return m_mtxView; }           // マトリクスビュー
    D3DXMATRIX GetMtxProj()const { return m_mtxProjection; }     // プロジェクト
    float GetVartical()const     { return m_fVartical; }         // 縦の回転
    float GetHorizontal()const   { return m_fHorizontal; }       // 横の回転
    float GetDistance()const     { return m_fDistance; }         // 距離
