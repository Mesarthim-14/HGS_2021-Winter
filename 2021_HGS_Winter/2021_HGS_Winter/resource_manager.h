...
public:
    ...
    // Get関数
    CTexture *GetTextureClass()const    { return m_pTexture; }  // テクスチャの情報
    CXfile *GetXfileClass()const        { return m_pXFile; }    // テクスチャの情報
    CSound *GetSoundClass()const        { return m_pSound; }    // サウンドの情報
