...
//#define RANKING_POS_X	(1000.0f)		// ランキングの横の座標
//#define RANKING_POS_Y	(150.0f)		// ランキングの縦の座標
...
//
//private:
//	CNumber2d *m_apRanking[MAX_RANKING][MAX_NUMBER];	// 桁数分
//	CNumber2d *m_apMyRanking[MAX_NUMBER];				// 自分のスコア表示
